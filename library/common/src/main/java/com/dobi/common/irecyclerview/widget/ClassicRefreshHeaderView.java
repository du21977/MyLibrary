package com.dobi.common.irecyclerview.widget;
...
import com.dobi.common.irecyclerview.RefreshTrigger;
...
public class ClassicRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public void onMove(boolean isComplete, boolean automatic, int moved) {
        if (!isComplete) {
            ...
            if (moved <= mHeight) {
                ...
                tvRefresh.setText(R.string.swipe);
            } else {
                tvRefresh.setText(R.string.release_to_refersh);
                if (!rotated) {
                    ivArrow.clearAnimation();
    ...
    public void onRefresh() {
        ...
        tvRefresh.setVisibility(VISIBLE);
        tvRefresh.setText(R.string.refershing);
    }
...
//        ivSuccess.setVisibility(VISIBLE);
        ...
        tvRefresh.setText(R.string.refersh_finish);
    }
