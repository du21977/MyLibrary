package com.dobi.common.recycleview.widget;
...
public class LoadRecycleView extends WrapRecyclerView {
    ...
    // 当前的状态
    public static int mCurrentLoadStatus;
    // 默认状态
    ...
    // 没有更多更多状态
    public static int LOAD_STATUS_NO_MORE = 0x0055;
    ...
    public boolean onTouchEvent(MotionEvent e) {
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                //add by me  如果状态没有更多了，则什么都不用处理
                if(mCurrentLoadStatus == LOAD_STATUS_NO_MORE){
                    return super.onTouchEvent(e);
                }
    ...
    // add by du
    //没有更多了
    public void onSetNoMore(){
        mCurrentLoadStatus = LOAD_STATUS_NO_MORE;
        if (mLoadCreator != null) {
            mLoadCreator.onStopLoad();
        }
    }
    ...
    // 处理加载更多回调监听
    private LoadRefreshRecyclerView.OnLoadMoreListener mListener;

    public void setOnLoadMoreListener(LoadRefreshRecyclerView.OnLoadMoreListener listener) {
