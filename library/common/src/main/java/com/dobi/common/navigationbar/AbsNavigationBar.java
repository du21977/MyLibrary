package com.dobi.common.navigationbar;
...
public abstract class AbsNavigationBar<P extends AbsNavigationBar.Builder.AbsNavigationParams> implements INavigationBar {
    ...
    private void createAndBindView() {
        ...
        mNavigationView = LayoutInflater.from(mParams.mContext).
                inflate(bindLayoutId(), mParams.mParent, false);// 插件换肤再去看源码

        // 2.添加到布局的第0个位置----考虑到有沉浸式状态栏所以加到第一个位置
        mParams.mParent.addView(mNavigationView, 1);
