...
public class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int TITLE = 0x111;
    public static final  int TYPE_NOW = 11;
    public static final  int TYPE_Trailer = 121;
    ...
    private boolean isFullSpanType(int type) {      //TYPE_Trailer
        return type == TYPE_Trailer ||type == REFRESH_HEADER || type == HEADER || type == FOOTER || type == LOAD_MORE_FOOTER || type ==TITLE || type == TYPE_NOW;
    }
